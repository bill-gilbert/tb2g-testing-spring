...
class OwnerControllerTest {
    ...
    public static final String FIND_JUST_ONE = "FindJustOne";
    @Autowired
    ...
    void testFindOwnersOneResult() throws Exception {
        ...
        justOne.setId(1);
        justOne.setLastName(FIND_JUST_ONE);

        given(clinicService.findOwnerByLastName(FIND_JUST_ONE)).willReturn(Lists.newArrayList(justOne));
        mockMvc.perform(get("/owners")
                        .param("lastName", FIND_JUST_ONE))
